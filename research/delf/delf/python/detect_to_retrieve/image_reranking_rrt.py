...
def MatchFeatures(query_locations,
  ...
  return sum(inliers), match_viz_bytes, cur_t
...
def RerankByGeometricVerification(input_ranks,
  ...
  for i in range(num_to_rerank):
    ...
    curr_rrt_feats = rrt_feats[i]
    curr_rrt_feats_1 = curr_rrt_feats[query_id]
    curr_rrt_feats_2 = curr_rrt_feats[70+query_id]

    curr_rrt_feats_1_norm = LA.norm(curr_rrt_feats_1, axis=-1)
    curr_rrt_feats_2_norm = LA.norm(curr_rrt_feats_2, axis=-1)
    curr_rrt_feats_1 = curr_rrt_feats_1/curr_rrt_feats_1_norm[:,None]
    curr_rrt_feats_2 = curr_rrt_feats_2/curr_rrt_feats_2_norm[:,None]

    
    # print('curr_rrt_feats', curr_rrt_feats.shape)
    # print('curr_rrt_feats_1', curr_rrt_feats_1.shape)
    # print('curr_rrt_feats_2', curr_rrt_feats_2.shape)
    # print('query_descriptors', query_descriptors.shape)
  ...
  return output_ranks, total_time
